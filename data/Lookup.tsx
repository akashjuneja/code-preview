...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Live Code Preview',
  SIGNIN_SUBHEADING: 'To use Live Code Preview you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Live Code Preview, you agree to the collection of usage data for analytics.',
